 ...
 CONSTRAINT PKID PRIMARY KEY(Product_ID),
 CONSTRAINT UQName UNIQUE(Product_Name),
 CONSTRAINT Qt CHECK(Quantity_On_Hand >= 0),
 CONSTRAINT PUnit CHECK(Product_Unit_Price >= 0),
 CONSTRAINT ROL CHECK(Reorder_Level >= 0)
 );
